<div class="relative h-full  overflow-y-scroll">
    ...
    <div
        class="relative flex min-h-80 flex-col gap-y-[2px] overflow-x-clip border-t-2 bg-gray-200 dark:border-slate-900 dark:bg-slate-900 [&>div:has(.month-name-spacer):first-of-type_.month-name-spacer]:h-9 [&>div:has(.month-name-spacer):not(:first-of-type)_.month-name-spacer]:hidden"
        x-ref="calendar"
        {{-- :class="{
