...
Route::prefix('/calendars')->name('calendars.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::put('/{calendar}', [CalendarController::class, 'update'])->middleware('can:update,calendar')->name('update');
        Route::delete('/{calendar}', [CalendarController::class, 'destroy'])->middleware('can:delete,calendar')->name('destroy');
    });
    ...
    Route::prefix('/{calendar}/events')->name('events.')->group(function () {
        ...
        Route::middleware('auth:sanctum')->group(function () {
            Route::post('/', [CalendarEventController::class, 'store'])->middleware('can:create,event')->name('store');
        });
    });
});
...
Route::prefix('/events')->name('events.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        Route::put('/{event}', [EventsController::class, 'update'])->middleware('can:update,event')->name('update');
        Route::delete('/{event}', [EventsController::class, 'destroy'])->middleware('can:delete,event')->name('destroy');
    });
});
